...
export default function ProductPage() {
  ...
  const whatsappMsg = `Hola, me interesa el ${product.name}${selectedStorage ? ` de ${selectedStorage}` : ""}${selectedColor ? ` en ${selectedColor}` : ""}. ¿Tienen disponibilidad?`;
    ...
    <div className="pt-16 min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div className="aspect-square bg-neutral-50 rounded-3xl flex items-center justify-center p-12 overflow-hidden">
              {product.badge && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400 mt-1">
                Precio puede variar según almacenamiento y color
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3.5 rounded-2xl font-semibold text-base transition-all active:scale-98 ${
                  added
              ...
              <a
                href={`https://wa.me/573001234567?text=${encodeURIComponent(whatsappMsg)}`}
                target="_blank"
